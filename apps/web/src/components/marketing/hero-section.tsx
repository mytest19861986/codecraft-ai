...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      <div className="mx-auto grid min-h-[calc(100svh-4rem)] w-full max-w-6xl gap-8 px-5 py-12 sm:gap-12 sm:px-7 sm:py-18 lg:min-h-[calc(100vh-4rem)] lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-8 lg:px-5">
        ...
        <div className="rounded-lg border border-purple-500/35 bg-[#0d0d13] p-3 shadow-[0_0_34px_rgba(168,85,247,0.18)] sm:p-4">
          <div className="rounded-lg border border-white/10 bg-[#10111a] p-3 shadow-[inset_0_0_24px_rgba(168,85,247,0.08)] sm:p-4">
            <div className="mb-4 flex gap-2">
              <span className="size-3 rounded-full bg-[#ff5f57]" />
              <span className="size-3 rounded-full bg-[#ffbd2e]" />
              <span className="size-3 rounded-full bg-[#28c840]" />
            </div>
            <pre className="overflow-x-auto whitespace-pre rounded-md border border-purple-500/20 bg-black/35 p-4 text-left font-mono text-xs leading-6 text-[#e6e8f8] shadow-[0_0_22px_rgba(155,92,255,0.12)] md:p-6 md:text-sm" dir="ltr">
{`const mission = {
  player: "teen_builder",
