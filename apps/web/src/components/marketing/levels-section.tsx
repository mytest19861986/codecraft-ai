...
const levels = [
  ...
  },
  {
    ...
    capstone: "ساخت دستیار صوتی اختصاصی و مینی‌کلون ChatGPT متصل به AI API."
  },
  {
    title: "LEVEL 03 // توسعه مینی‌اپ‌های فول‌استک (۵۰۰ XP)",
    description:
      "ساخت دیتابیس، معماری بک‌اِند و ورود به معدن طلای سال ۲۰۲۶؛ یعنی مینی‌اپلیکیشن‌های تلگرام.",
    capstone: "ساخت مینی‌اپ فروشگاهی/بازی داخل تلگرام متصل به درگاه پرداخت تستی."
  },
  {
