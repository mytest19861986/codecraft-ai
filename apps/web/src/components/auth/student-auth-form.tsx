...
const copy = {
  login: {
    ...
    description: "شماره موبایل و رمزت رو بزن تا مسیر درس‌ها، XP و مرحله بعدی یادگیریت رو از داشبورد دنبال کنی.",
  ...
  register: {
    ...
    description: "با یک شماره موبایل و رمز امن، پروفایل یادگیریت رو بساز و وارد مسیر پروژه‌ها، ماموریت‌ها و XP شو.",
    submit: "ساخت اکانت",
...
const errorMessages: Record<string, string> = {
  DUPLICATE_PHONE: "این شماره قبلا ثبت شده است. اگر اکانت داری، از صفحه ورود استفاده کن.",
