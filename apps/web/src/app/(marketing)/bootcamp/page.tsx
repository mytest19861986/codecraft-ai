    ...
    <section className="mx-auto grid w-full max-w-6xl gap-8 px-5 py-12 sm:py-16 lg:grid-cols-[1fr_0.9fr] lg:items-start">
      <div className="pt-4">
        <SectionHeading
          ...
          subtitle="اطلاعات اولیه رو وارد کن تا تیم کدکرافت برای هماهنگی مسیر مناسب باهات تماس بگیره. پس از ثبت‌نام، مسیر ورود به مینی‌دوره از راه‌های رسمی کدکرافت اطلاع‌رسانی می‌شود."
        />
